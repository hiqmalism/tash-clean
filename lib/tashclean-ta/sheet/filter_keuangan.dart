            ...
            Column(
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      filterKategori('Pemasukan', 'pemasukan'),
                      filterKategori('Pengeluaran', 'pengeluaran'),
                    ],
                  ),
                ),
                SizedBox(height: 10),
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      filterWaktu('Hari ini', 'daily'),
                      filterWaktu('Minggu ini', 'weekly'),
                      filterWaktu('Bulan ini', 'monthly'),
                    ],
                  ),
                ),
                Center(
